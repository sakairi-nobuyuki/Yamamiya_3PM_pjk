...
class TestCustomDatasetLoader:
    def test_init(self, mock_datasetloader_parameters: DatasetLoaderParameters, mock_s3_dataset: S3ImageIO):
        dataset_loader = CustomDatasetLoader(mock_datasetloader_parameters, mock_s3_dataset)
