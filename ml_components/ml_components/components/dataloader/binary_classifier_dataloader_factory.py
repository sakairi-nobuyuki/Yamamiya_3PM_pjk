...
class BinaryClassifierDataloaderFactory:
    ...
    def create(self, data_path: str) -> ClassifierDataloaderDataclass:
        ...
        val_dataset = datasets.ImageFolder(f"{data_path}/validation", transform=self.train_transforms)
        ...
        return ClassifierDataloaderDataclass(train_loader=train_loader, validation_loader=val_loader)