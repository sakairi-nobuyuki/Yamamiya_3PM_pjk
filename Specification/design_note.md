...
- リレーの選定:
  ...
  - 候補2: 
    ...
    - コイル電圧: DV12V 72A
    - 接点定格電圧: AC220V 5A
    - https://www.fa.omron.co.jp/product/item/7265/
...
- モータドライバボードキット
  - 自前でICを乗せた板を作るのが大変なので、秋月のモータドライバキットを使用する。候補になるドライバ。
    - TB6612モータードライバー ブレークアウトボードキット
      - URL: https://akizukidenshi.com/catalog/g/g116947/
      - VC: 2.7 - 5.5V
      - VM: 2.5 - 13.5V
      - 最大電流: 1.2A
      - 回路の数: 2
    - L6470使用 ステッピングモータードライブキット
      - URL: https://akizukidenshi.com/catalog/g/g107024/
      - VC: 3 - 5.5V
      - VM: 8 - 45V
